...
import { mascararNome, mascararEmail, mascararCPF, mascararCNPJ, mascararDados } from "../Utils/mascarar";
...
function preencherPerfilCandidato(candidato: Candidato): void {
    ...
    if (emailElement) emailElement.textContent = mascararDados(candidato.email, 'email');
    ...
    if (cpfElement) cpfElement.textContent = mascararDados(candidato.cpf, 'cpf');
                ...
                <div class="col">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text">CNPJ: ${mascararDados(empresa.cnpj, 'cnpj')}</p>
                            <p class="card-text">Estado: ${empresa.estado}</p>
                            <p class="card-text">CEP: ${empresa.cep}</p>
                            <p class="card-text">Email: ${mascararDados(empresa.email, 'email')}</p>
